...
import com.cookie14.foodcommnet.api.DataClass.ArticleModel
import com.cookie14.foodcommnet.databinding.ItemMainArticleBinding
...
class MainArticleAdapter() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        binding = ItemMainArticleBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        //物件導向
